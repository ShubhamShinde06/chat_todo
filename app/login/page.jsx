...
const Page = () => {
  ...
  return (
    <div className="w-full h-[100vh] flex items-center justify-center bg-[#04C582]">
      ...
      <section className="w-[350px] md:w-[400px] h-auto  rounded-3xl p-10 text-center text-[white] bg-[#2E3137]">
        ...
        <form onSubmit={loginHandler}>
          ...
          /><br></br>
          <button type="submit" className="w-[150px] h-[35px] rounded-xl bg-[#04C582] mt-5 text-[18px] mb-5">Login</button>
          <br></br>
          <p>OR</p>
